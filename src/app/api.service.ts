...
export class ApiService {
    ...
    // vars
    redirectUrl: any;
    WaifuLink:string = "https://google.com/php"; //url from php folder
    ...
    public userlogin(username:any, password:any) {
        alert(username)
        return this.httpClient.post<any>(this.WaifuLink + '/login.php', { username, password })
    ...
    public userregistration(name:any,email:any,pwd:any) {
        return this.httpClient.post<any>(this.WaifuLink + '/register.php', { name,email, pwd })
